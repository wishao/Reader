...
public class Database extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE t_book(id VARCHAR(36) NOT NULL,name TEXT(100) NOT NULL,author VARCHAR(20),content VARCHAR(100) NOT NULL,create_time DATETIME NOT NULL,update_time DATETIME NOT NULL,recommend TEXT(100),cover VARCHAR(100),reader INT NOT NULL,focus INT NOT NULL,catalog TEXT(100),score INT NOT NULL,status TINYINT(4) NOT NULL,PRIMARY KEY (id));");
